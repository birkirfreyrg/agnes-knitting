...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_recommendations_type" AS ENUM('Vörumerki', 'Búð', 'Vara');
  CREATE TYPE "public"."enum_recommendations_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__recommendations_v_version_type" AS ENUM('Vörumerki', 'Búð', 'Vara');
  CREATE TYPE "public"."enum__recommendations_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE "_posts_v" (
  	...
  	"version_read_time" varchar DEFAULT '5 min read',
  ...
  CREATE TABLE "recommendations" (
  	...
  	"name" varchar,
  	"description" varchar,
  	"type" "enum_recommendations_type" DEFAULT 'Vara',
  	"image_id" integer,
  	"link" varchar,
  	"published_at" timestamp(3) with time zone,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_recommendations_status" DEFAULT 'draft'
  );
  ...
  CREATE TABLE "_recommendations_v" (
  	...
  	"version_type" "enum__recommendations_v_version_type" DEFAULT 'Vara',
  	"version_image_id" integer,
  	"version_link" varchar,
  	"version_published_at" timestamp(3) with time zone,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__recommendations_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  ALTER TABLE "recommendations" ADD CONSTRAINT "recommendations_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_recommendations_v" ADD CONSTRAINT "_recommendations_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "recommendations_image_idx" ON "recommendations" USING btree ("image_id");
  ...
  CREATE INDEX "recommendations__status_idx" ON "recommendations" USING btree ("_status");
  CREATE INDEX "_recommendations_v_parent_idx" ON "_recommendations_v" USING btree ("parent_id");
  CREATE INDEX "_recommendations_v_version_version_image_idx" ON "_recommendations_v" USING btree ("version_image_id");
  ...
  CREATE INDEX "_recommendations_v_version_version__status_idx" ON "_recommendations_v" USING btree ("version__status");
  ...
  CREATE INDEX "_recommendations_v_latest_idx" ON "_recommendations_v" USING btree ("latest");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_recommendations_type";
  DROP TYPE "public"."enum_recommendations_status";
  DROP TYPE "public"."enum__recommendations_v_version_type";
  DROP TYPE "public"."enum__recommendations_v_version_status";`)
}
